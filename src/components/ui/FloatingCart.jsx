...
export default function FloatingCart() {
  ...
  return (
    <div className="fixed bottom-[4.5rem] inset-x-4 z-50 md:bottom-8 md:max-w-md md:mx-auto transition-all duration-500 animate-in slide-in-from-bottom-10 fade-in pointer-events-auto">
